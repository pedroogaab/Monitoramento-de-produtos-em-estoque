...
"""
Use > pip install kagglehub < to install the Kaggle API client if not already installed.
create a kaggle.json file with your Kaggle API credentials in the same directory as this script.
in "https://www.kaggle.com/settings" > Create Legacy API Token > Download API Token
Save the downloaded kaggle.json file in the same directory as this script.
"""
